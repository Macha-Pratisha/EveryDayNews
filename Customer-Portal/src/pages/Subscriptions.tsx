...
// ">My Subscriptions</h1>
//         <p className="text-muted-foreground mt-1 text-amber-600">Manage your active newspaper subscriptions</p>
//       </div>
...
//             <Button className="mt-4" onClick={() => window.location.href = '/new-subscription'}>
...
//                       <AvatarFallback>
//                         {subscription.deliveryPerson.name.split(' ').map(n => n[0]).join('')}
//                       </AvatarFallback>
//                     </Avatar>
//                     <div className="flex-1">
//                       <p className="font-medium">Delivery Person</p>
//                       <p className="text-sm text-muted-foreground">{subscription.deliveryPerson.name}</p>
//                       <p className="text-sm text-muted-foreground">{subscription.deliveryPerson.phone}</p>
//                     </div>
//                   </div>
//                 )}
